<template>
  <div id="app">
    ...
    <div
      ...
      class="col-xs-11 col-sm-4 alert alert-primary notify-alert animated bounce"
      role="alert"
    ...
    >
      <button type="button" aria-hidden="true" class="close" data-notify="dismiss" style="display: none; position: absolute; right: 10px; top: 5px; z-index: 100002">×</button
      ><span data-notify="icon" class="0"></span> <span data-notify="title">{{ alertTitle }}</span> <span data-notify="message">{{ alertMessage }}</span

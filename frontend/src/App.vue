<template>
  <div id="app">
    ...
    <div v-if="accessAlert" data-notify="container"
      class="col-xs-11 col-sm-4 alert alert-primary notify-alert animated bounce" role="alert"
      ...
      <button type="button" aria-hidden="true" class="close" data-notify="dismiss"
        ...
        data-notify="message">{{ alertMessage }}</span><a href="#" target="_blank" data-notify="url"></a>
    </div>
  </div>
</template>

<template>
  <div class="container mt-4">
    ...
    <div class="mt-3 mb-3">
      ...
      <input class="form-control" placeholder="your-email@domain.com" readonly v-model="userEmail">
    </div>
    <div class="mb-3">
    ...
    <div class="form-footer text-end">
      <button class="btn btn-primary btn-block" @click="profileModify">저장</button>
    </div></div>
  </template>

        ...
        <form class="theme-form login-form">
            ...
            <div class="form-builder-header-1 mb-4">
                <ul class="nav nav-primary justify-content-center">
                    <li class="nav-item" @click="codeToggle"><a class="nav-link m-r-5"
                            :class="{ 'active': code == '100' }" style="border-radius: 5px">일반회원</a></li>
                    <li class="nav-item" @click="codeToggle"><a class="nav-link m-r-5"
                            :class="{ 'active': code == '200' }" style="border-radius: 5px">기업회원</a></li>
                </ul>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="small-group">
                    <div class="input-group"><span class="input-group-text"><i class="icon-user"></i></span>
                        <input class="form-control" :class="{ 'input-error': isUserName }" type="text"
            ...
            <div class="form-group">
                ...
                <div v-show="popupEmail" class="popover fade show bs-popover-end"
                    ...
                    <div class="popover-arrow" style="position: absolute; top: 0px; transform: translate(0px, 15px);">
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group"><span class="input-group-text"><i class="icon-lock"></i></span>
                    <input class="form-control" :class="{ 'input-error': isUserPassword }" type="password"
            ...
            <div class="form-group">
                <label>Tel</label>
                <div class="input-group"><span class="input-group-text"><i class="icofont icofont-iphone"></i></span>
                    <input class="form-control" :class="{ 'input-error': isUserTel }" type="text"
                        placeholder="010-1234-5678" v-model="userTel">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-xl-4 col-sm-12 col-md-12 mb-2">
                        ...
                        <select class="form-select form-control" :class="{ 'input-error': isSelectedSido }"
                    ...
                    <div class="col-xl-4 col-sm-12 col-md-12 mb-2">
                        ...
                        <select class="form-select form-control" :class="{ 'input-error': isSelectedGugun }"
                    ...
                    <div class="col-xl-4 col-sm-12 col-md-12 mb-2">
                        ...
                        <select class="form-select form-control" :class="{ 'input-error': isSelectedDong }"
                ...
                <div class="row">
                    <div class="col-xl-12 col-sm-12 col-md-12 mb-2">
                        ...
                        <input class="form-control" :class="{ 'input-error': isDetailAddress }" type="text"
                            placeholder="상세 주소" v-model="detailAddress" />
                    </div>
                </div>
            </div>

<template>
  <div>
    <div class="container-fluid">
      <basic-header name="매물 조회"></basic-header>
    </div>
    <div class="container-fluid">
      <div class="row">
        <!--검색영역-->
...
export default {
  ...
  methods: {
    ...
    search() {
      this.searchWord = this.beforeSearchWord;
    },
  },
};
</script>

  ...
  <div class="page-main-header">
    <div class="main-header-right row m-0">
      <div class="main-header-left">
        <div class="logo-wrapper"><router-link to="/"><img class="img-fluid" src="@/assets/image/logo.png"
              alt=""></router-link></div>
        <div class="toggle-sidebar">
          <feather type="align-center" class="status_toggle middle" id="sidebar-toggle" />
        </div>
      </div>
